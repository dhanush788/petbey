        ...
        <div className='md:max-w-lg flex flex-col gap-4'>
          ...
          <div className='flex flex-row gap-4'>
            <div className='px-6 py-2 bg-white bg-opacity-10 rounded-full flex flex-row gap-2 items-center'>
              ...
              <a href='https://apps.apple.com/us/app/petbey-where-pets-find-homes/id6477542468' className={`${styles.heroSubText2}`} target="_blank" rel="noopener noreferrer">App Store</a>
            </div>
            <div className='px-6 py-2 bg-white bg-opacity-10 rounded-full flex flex-row gap-2 items-center'>

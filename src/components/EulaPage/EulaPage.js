...
const EULAPage = () => {
  return (
    <div className="eula-page">
      ...
      <section className="eula-content">
        <p>
          Petbey: Where Pets Find Homes is licensed to You (End-User) by Petbey
          India Private Limited, located at Kottakkal, Near Bus Stand,
          Malappuram, Kerala 676503, India ("Licensor"), for use only under the
        ...
        <p>
          ...
          such as warranty, liability, maintenance and support thereof. Petbey
          India Private Limited, not the Services, is solely responsible for the
        ...
        <p>
          ...
          Rules"). Petbey India Private Limited acknowledges that it had the
          opportunity to review the Usage Rules and this License Agreement is
          not conflicting with them.
        </p>
        <p>
          Petbey: Where Pets Find Homes when purchased or downloaded through the
          ...
          granted to You. Petbey: Where Pets Find Homes is to be used on devices
          that operate with Apple's operating systems ("iOS" and "Mac OS") or
          Google's operating system ("Android").
        </p>
        <h2>1. THE APPLICATION</h2>
        <p>
          Petbey: Where Pets Find Homes ("Licensed Application") is a piece of
          software created to Market place for pets — and customized for iOS and
          Android mobile devices ("Devices"). It is used to Viewing pets and
        ...
        <p>
          2.1 You are granted a non-transferable, non-exclusive,
        ...
        <p>
          ...
          with Petbey India Private Limited's prior written consent), sell,
        ...
        <p>
          ...
          Application, or any part thereof (except with Petbey India Private
        ...
        <p>
          4.2 Petbey India Private Limited and the End-User acknowledge that the
        ...
        <p>
          ...
          there are any other reasons outside of Petbey India Private Limited's
          sphere of influence that affect the executability of the Licensed
          Application.
        </p>

        <p>
          9.3 You are required to inspect the Licensed Application immediately
          after installing it and notify Petbey India Private Limited about
          ...
          further investigated if it has been emailed within a period of ______
          days after discovery.
        </p>

        <p>
          9.4 If we confirm that the Licensed Application is defective, Petbey
          India Private Limited reserves a choice to remedy the situation either
        ...
        <p>
          Petbey India Private Limited and the End-User acknowledge that Petbey
          India Private Limited, and not the Services, is responsible for
          addressing any claims of the End-User or any third party relating to
          the Licensed Application or the End-User&apos;s possession and/or use
        ...
        <address>
          Shahidali Paravakkal Kottakkal
          <br />
          Near Bus Stand Malappuram, Kerala 676503 India
          <br />
          <a href="mailto:contact@petbey.in">contact@petbey.in</a>
        </address>

        <h2>13. TERMINATION</h2>
        <p>
          The license is valid until terminated by Petbey India Private Limited
          or by You. Your rights under this license will terminate automatically
          and without notice from Petbey India Private Limited if You fail to
          adhere to any term(s) of this license. Upon License termination, You
        ...
        <p>
          Petbey India Private Limited represents and warrants that Petbey India
          Private Limited will comply with applicable third-party terms of
        ...
        <p>
          Petbey India Private Limited and the End-User acknowledge that, in the
          ...
          on the third party's intellectual property rights, Petbey India
          Private Limited, and not the Services, will be solely responsible for
        ...
        <p>
          This License Agreement is governed by the laws of India excluding its
